...
<div class="tbd16-info" markdown="0">
  <span class="tbd16-info-status">Preview</span>
  <span class="tbd16-info-body">The tbd 16 groovebox has not been released yet — content may change.</span>
  <span class="tbd16-info-meta">Firmware <code>{{ site.tbd16.firmware_version }}</code> · Updated {{ site.tbd16.manual_updated }}</span>
</div>
...
![tbd 16](../images/tbd-16/dadamachines-tbd16-mockup.png)
